# AGENTS.md — Azureus Project Conventions for Codex

> This file is read by Codex at the start of every session. Keep it short, opinionated, and current. When project conventions change, update this file first.
...
1. This file (`AGENTS.md`) — conventions and rules
...
**End of AGENTS.md. Last updated: project planning lock (v1.0).**
